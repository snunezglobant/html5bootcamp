...
var MovieView = Backbone.View.extend({
  ...
  updateMovie : function(){
    ...
    var newYear = prompt("Please enter the new year", this.model.get('year'));
    var newDesc = prompt("Please enter the new description", this.model.get('description'));
    if(!newTitle || !newYear || !newDesc)return;
...
var MoviesList = Backbone.View.extend({
  ...
  add: function(e){
      ...
      e.preventDefault();
      var newMovieTitle = $('#addMovie').find('input[type=text]').val();
      var newId=(movies.lenght)+1 
      
     movies.add({ id: newId, title: newMovieTitle });
